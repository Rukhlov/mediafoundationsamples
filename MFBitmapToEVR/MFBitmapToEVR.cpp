...
#define BITMAP_WIDTH  80//4196//160//320//640
#define BITMAP_HEIGHT 60//4196//120//240//480
#define SAMPLE_DURATION 10000//000 // 10^7 corresponds to 1 second.
...
int main()
{
    ...
    while (true)//bitmapCount < SAMPLE_COUNT)
    {
